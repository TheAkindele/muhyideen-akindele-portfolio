  ...
  return (
    <section className="landing_container" id="landing">
      ...
      <main>
        ...
        <a
          href="https://docs.google.com/document/d/1SfsHW6eD_Ru4JZwM5EFd6tBO2A_ZMRyIInGwqpZCfOY/edit?usp=sharing"
          target="_blank"
          rel="noopener noreferrer"
          className="download-btn"
        >
          <Button text="Resume" btnType="primary" className="landing_btn" />
        </a>
      </main>
